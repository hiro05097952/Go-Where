<template>
  <div class="customer_orders">
      ...
      <div class="col-md-4 mb-4" v-for="(item, key) in products" :key="key">
        <div class="card border-0 shadow-sm">
          ...
          <div class="card-footer d-flex">
            ...
            >
              <i class="fas fa-spinner fa-spin" v-if="selected === item.id" />
              查看更多
            </button>
            <button
              type="button"
      ...
      <div class="modal-dialog modal-md" role="document">
        <div class="modal-content border-0">
          ...
          <div class="modal-body">
            <div class="row">
              <div class="col">
                ...
                >
                <h5 class="font-weight-normal mt-3 mb-4">
                  {{ product.content }}
                </h5>
                <div class="d-flex justify-content-between align-items-baseline">
                  <del class="h6">原價 {{ product.origin_price || 0 }} 元</del>
                  <div class="h4">
                    現在只要 {{ product.price || 0 }} 元
                  </div>
                </div>
                <select
          ...
          <div class="modal-footer">
            <h6 class="mr-4 pt-2">
              總計 {{ product.price * butQty || 0 }} 元
            </h6>
            <button
              type="button"
              class="btn btn-success"
              @click="addtoCart(product.id, butQty)"
            >
              加到購物車
            </button>
          </div>
    ...
    <!-- 購物車 -->
    <div class="d-block mx-auto mt-4" style="width: 60%;" v-if="cart.carts.length !== 0">
      <table class="table">
        <thead>
          <th />
          <th>品名</th>
    ...
    <div class="my-5 row justify-content-center">
      <form class="col-md-6">
        ...
        <div class="text-right">
          <button class="btn btn-danger" @click.prevent="formCommit">
            送出訂單
          </button>
        </div>
      </form>
